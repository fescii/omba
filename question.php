...
<div class="container main-container">
  <div class="row">
    ...
    <div class="col-md-9 main_content">
       ...
       <p class="question_meta"><strong>Posted On: </strong><?php $dt = new DateTime($meta);
        echo $dt->format('M j Y'); ?></p>
      ...
      <?php }?> <hr>
       ...
       if(isset($_SESSION['user_loggedin'])){ ?>
         <form action="question.php?q_id=<?php echo $_GET['q_id']; ?>" method="post">
            <textarea name="answer" rows="5" class="form-control" placeholder="Write Your Prayer"></textarea> <br>
            <input type="submit" value="Post Your Prayer" class="btn btn-primary">
         </form>
       <?php } ?>
